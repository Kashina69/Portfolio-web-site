      ...
      <div className="max-w-[1240px] m-auto md:grid grid-cols-3 gap-8 ">
        <div className="col-span-2">
          ...
          <p className="py-2 text-gray-600 md:mr-9">
            ...
            full stack web applications. Amazing Applications that connect with API’s
            and backend. I’m passionate about learning new
            ...
            using React, Next.js and Tailwind I am a quick learner and can pick up new
            tech stacks as needed. I believe that being a great developer is not
            about using one specific language or technology, but choosing the best tool for the job.
          </p>
          <p className="py-2 text-gray-600 md:mr-9">
            I have been learning programming and web developement since 2021  
            In my spare time i like to play Games <a href="https://playvalorant.com/en-us/" target="_blank" className="hover:text-[#5651e5] text-purple-400 font-bold">(Valorant)</a>, Learning new technologies, Science, PC Building, <a href="https://music.youtube.com/playlist?list=PL6g8vO0WbAnzlVhMuCguuKt7M00X-gu01" target="_blank" className="hover:text-[#5651e5] text-purple-400 font-bold">Listening  to music</a> and <a href="https://myanimelist.net/animelist/Prince_rawat" target="_blank" className="hover:text-[#5651e5] text-purple-400 font-bold">Watching Anime</a> 
          </p>
